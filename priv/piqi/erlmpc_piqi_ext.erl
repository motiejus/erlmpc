...
parse_command_list(X, Format) ->
    erlmpc_piqi:parse_command_list(
        piqirun_ext:convert(?MODULE, <<"erlmpc/command-list">>, Format, 'pb', X)).

parse_command_list(X, Format, Options) ->
    erlmpc_piqi:parse_command_list(
        piqirun_ext:convert(?MODULE, <<"erlmpc/command-list">>, Format, 'pb', X, Options)).
...
gen_command_list(X, Format) ->
    Iolist = erlmpc_piqi:gen_command_list(X),
    piqirun_ext:convert(?MODULE, <<"erlmpc/command-list">>, 'pb', Format, iolist_to_binary(Iolist)).

gen_command_list(X, Format, Options) ->
    Iolist = erlmpc_piqi:gen_command_list(X),
    piqirun_ext:convert(?MODULE, <<"erlmpc/command-list">>, 'pb', Format, iolist_to_binary(Iolist), Options).
